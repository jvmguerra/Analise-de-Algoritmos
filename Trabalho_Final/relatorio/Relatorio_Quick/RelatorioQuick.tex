...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[scale=0.6]{../imagens/Quick/Quick_plot_1_aleatorio.png}
	...
	\item Para um vetor ordenado crescente
		\begin{enumerate}
			\item Complexidade de custo do método Quick Sort disponível na lista de imagens ~\ref{fig:QuickPlot1OC}.
			\begin{figure}[!h]
				\centering
				\includegraphics[scale=0.6]{../imagens/Quick/Quick_plot_1_ordenado_crescente.png}
				\caption{Complexidade de custo do método Quick Sort (Vetor Ordenado Crescente)\label{fig:QuickPlot1OC}}
			\end{figure}
			...
			\begin{figure}[!h]
				\centering
				\includegraphics[scale=0.6]{../imagens/Quick/Quick_plot_3_ordenado_crescente.png}
		...
		\item Para um vetor ordenado decrescente
				\begin{enumerate}
					\item Complexidade de custo do método Quick Sort disponível na lista de imagens ~\ref{fig:QuickPlot1OD}.
					\begin{figure}[!h]
						\centering
						\includegraphics[scale=0.6]{../imagens/Quick/Quick_plot_1_ordenado_decrescente.png}
						\caption{Complexidade de custo do método Quick Sort (Vetor Ordenado Decrescente) \label{fig:QuickPlot1OD}}
					\end{figure}
			...
			\item Para um vetor parcialmente ordenado crescente
							\begin{enumerate}
								...
								\begin{figure}[!h]
									\centering
									\includegraphics[scale=0.6]{../imagens/Quick/Quick_plot_1_parcialmente_ordenado_crescente.png}
			...
			\item Para um vetor parcialmente ordenado decrescente
										\begin{enumerate}
											\item Complexidade de custo do método Quick Sort disponível na lista de imagens ~\ref{fig:QuickPlot1POD}.
											\begin{figure}[!h]
												\centering
												\includegraphics[scale=0.6]{../imagens/Quick/Quick_plot_1_parcialmente_ordenado_decrescente.png}
												\caption{Complexidade de custo do método Quick Sort (Vetor Parcialmente Ordenado Decrescente) \label{fig:QuickPlot1POD}}
											\end{figure}
...
\chapter{Citações e referências bibliográficas}
	\begin{thebibliography}{1}
		...
		\bibitem{notes} Thomas H. Cormen {\em 
